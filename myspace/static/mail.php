...
if ($name == "") {
    ...
    $to = 'nikhilsonune.ec@gmail.com';
    $subject = 'Edu5 Contact Query';
    ...
    $headers .= 'From:  Edu5 <nikhilsonune.ec@gmail.com>' . "\r\n";
    $headers .= 'cc: nikhilsonune.ec@gmail.com' . "\r\n";
    $headers .= 'bcc: nikhilsonune.ec@gmail.com' . "\r\n";
    mail($to, $subject, $_message, $headers, '-f nikhilsonune.ec@gmail.com');
